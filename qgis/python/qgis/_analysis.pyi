...
class QgsAnalysis(PyQt5.sip.wrapper):
    ...
    @staticmethod
    def geometryCheckRegistry() -> 'QgsGeometryCheckRegistry|None': ...
    @staticmethod
    def instance() -> 'QgsAnalysis|None': ...


class QgsGcpGeometryTransformer(_core.QgsAbstractGeometryTransformer):

    @typing.overload
    def __init__(self, gcpTransformer: 'QgsGcpTransformerInterface|None') -> None: ...
    @typing.overload
    ...
    def setGcpTransformer(self, transformer: 'QgsGcpTransformerInterface|None') -> None: ...
    def gcpTransformer(self) -> 'QgsGcpTransformerInterface|None': ...
    def transform(self, geometry: _core.QgsGeometry, feedback: _core.QgsFeedback|None = ...) -> typing.Tuple[_core.QgsGeometry, bool]: ...
...
class QgsGcpTransformerInterface(PyQt5.sip.wrapper):
    ...
    @staticmethod
    def createFromParameters(method: 'QgsGcpTransformerInterface.TransformMethod', sourceCoordinates: collections.abc.Iterable[_core.QgsPointXY], destinationCoordinates: collections.abc.Iterable[_core.QgsPointXY]) -> 'QgsGcpTransformerInterface|None': ...
    @staticmethod
    def create(method: 'QgsGcpTransformerInterface.TransformMethod') -> 'QgsGcpTransformerInterface|None': ...
    @staticmethod
    ...
    def clone(self) -> 'QgsGcpTransformerInterface|None': ...
...
class QgsVectorWarper(PyQt5.sip.wrapper):
    ...
    def error(self) -> str: ...
    def transformFeatures(self, iterator: _core.QgsFeatureIterator, sink: _core.QgsFeatureSink|None, context: _core.QgsCoordinateTransformContext, feedback: _core.QgsFeedback|None = ...) -> bool: ...
...
class QgsVectorWarperTask(_core.QgsTask):
    ...
    def __init__(self, method: QgsGcpTransformerInterface.TransformMethod, points: collections.abc.Iterable[QgsGcpPoint], destinationCrs: _core.QgsCoordinateReferenceSystem, layer: _core.QgsVectorLayer|None, fileName: str|None) -> None: ...
...
class QgsGridFileWriter(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, interpolator: 'QgsInterpolator|None', outputPath: str|None, extent: _core.QgsRectangle, nCols: int, nRows: int) -> None: ...
    @typing.overload
    ...
    def setCreationOptions(self, options: collections.abc.Iterable[str|None]) -> None: ...
    def writeFile(self, feedback: _core.QgsFeedback|None = ...) -> int: ...
...
class QgsInterpolator(PyQt5.sip.wrapper):
    ...
    def cacheBaseData(self, feedback: _core.QgsFeedback|None = ...) -> 'QgsInterpolator.Result': ...
    def interpolatePoint(self, x: float, y: float, feedback: _core.QgsFeedback|None = ...) -> typing.Tuple[int, float]: ...
...
class QgsTinInterpolator(QgsInterpolator):
    ...
    @typing.overload
    def __init__(self, inputData: collections.abc.Iterable[QgsInterpolator.LayerData], interpolation: 'QgsTinInterpolator.TinInterpolation' = ..., feedback: _core.QgsFeedback|None = ...) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QgsTinInterpolator') -> None: ...

    def setTriangulationSink(self, sink: _core.QgsFeatureSink|None) -> None: ...
    @staticmethod
...
class QgsMeshContours(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, layer: _core.QgsMeshLayer|None) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QgsMeshContours') -> None: ...

    def exportPolygons(self, index: _core.QgsMeshDatasetIndex, min_value: float, max_value: float, method: _core.QgsMeshRendererScalarSettings.DataResamplingMethod, feedback: _core.QgsFeedback|None = ...) -> _core.QgsGeometry: ...
    def exportLines(self, index: _core.QgsMeshDatasetIndex, value: float, method: _core.QgsMeshRendererScalarSettings.DataResamplingMethod, feedback: _core.QgsFeedback|None = ...) -> _core.QgsGeometry: ...
...
class QgsMeshTriangulation(QtCore.QObject):
    ...
    def triangulatedMesh(self, feedback: _core.QgsFeedback|None = ...) -> _core.QgsMesh: ...
    def addVertex(self, vertex: _core.QgsPoint) -> int: ...
    def addBreakLines(self, lineFeatureIterator: _core.QgsFeatureIterator, valueAttribute: int, transformContext: _core.QgsCoordinateTransform, feedback: _core.QgsFeedback|None = ..., featureCount: int = ...) -> bool: ...
    def addVertices(self, vertexFeatureIterator: _core.QgsFeatureIterator, valueAttribute: int, transform: _core.QgsCoordinateTransform, feedback: _core.QgsFeedback|None = ..., featureCount: int = ...) -> bool: ...


class QgsMeshZValueDatasetGroup(_core.QgsMeshDatasetGroup):

    def __init__(self, datasetGroupName: str|None, mesh: _core.QgsMesh) -> None: ...
    ...
    def dataset(self, index: int) -> _core.QgsMeshDataset|None: ...
...
class QgsGraphAnalyzer(PyQt5.sip.wrapper):
    ...
    @staticmethod
    def shortestTree(source: QgsGraph|None, startVertexIdx: int, criterionNum: int) -> QgsGraph|None: ...
    @staticmethod
    def dijkstra(source: QgsGraph|None, startVertexIdx: int, criterionNum: int, resultTree: collections.abc.Iterable[int] = ..., resultCost: collections.abc.Iterable[float] = ...) -> list: ...


class QgsGraphBuilderInterface(PyQt5.sip.wrapper):

    @typing.overload
    def __init__(self, crs: _core.QgsCoordinateReferenceSystem, ctfEnabled: bool = ..., topologyTolerance: float = ..., ellipsoidID: str|None = ...) -> None: ...
    @typing.overload
    ...
    def distanceArea(self) -> _core.QgsDistanceArea|None: ...
...
class QgsGraphBuilder(QgsGraphBuilderInterface):
    ...
    def __init__(self, crs: _core.QgsCoordinateReferenceSystem, otfEnabled: bool = ..., topologyTolerance: float = ..., ellipsoidID: str|None = ...) -> None: ...

    def takeGraph(self) -> QgsGraph|None: ...
...
class QgsGraphDirector(QtCore.QObject):
    ...
    def name(self) -> str: ...
    def addStrategy(self, prop: 'QgsNetworkStrategy|None') -> None: ...
    def makeGraph(self, builder: QgsGraphBuilderInterface|None, additionalPoints: collections.abc.Iterable[_core.QgsPointXY], feedback: _core.QgsFeedback|None = ...) -> list[_core.QgsPointXY]: ...
...
class QgsVectorLayerDirector(QgsGraphDirector):
    ...
    def __init__(self, source: _core.QgsFeatureSource|None, directionFieldId: int, directDirectionValue: str|None, reverseDirectionValue: str|None, bothDirectionValue: str|None, defaultDirection: 'QgsVectorLayerDirector.Direction') -> None: ...
...
class QgsBatchGeocodeAlgorithm(_core.QgsProcessingFeatureBasedAlgorithm):
    ...
    def __init__(self, geocoder: _core.QgsGeocoderInterface|None) -> None: ...
    ...
    def processFeature(self, feature: _core.QgsFeature, a1: _core.QgsProcessingContext, feedback: _core.QgsProcessingFeedback|None) -> list[_core.QgsFeature]: ...
    def prepareAlgorithm(self, parameters: dict[str, typing.Any], context: _core.QgsProcessingContext, feedback: _core.QgsProcessingFeedback|None) -> bool: ...
    def outputName(self) -> str: ...
    def supportInPlaceEdit(self, layer: _core.QgsMapLayer|None) -> bool: ...
...
class QgsAlignRaster(PyQt5.sip.wrapper):
    ...
    class RasterInfo(PyQt5.sip.wrapper):
        ...
        def __init__(self, layerpath: str|None) -> None: ...
    ...
    @staticmethod
    def suggestedWarpOutput(info: 'QgsAlignRaster.RasterInfo', destWkt: str|None, cellSize: QtCore.QSizeF|None = ..., gridOffset: QtCore.QPointF|QtCore.QPoint = ..., rect: _core.QgsRectangle|None = ...) -> bool: ...
    ...
    @typing.overload
    def setParametersFromRaster(self, rasterInfo: 'QgsAlignRaster.RasterInfo', customCRSWkt: str|None = ..., customCellSize: QtCore.QSizeF = ..., customGridOffset: QtCore.QPointF|QtCore.QPoint = ...) -> bool: ...
    @typing.overload
    def setParametersFromRaster(self, filename: str|None, customCRSWkt: str|None = ..., customCellSize: QtCore.QSizeF = ..., customGridOffset: QtCore.QPointF|QtCore.QPoint = ...) -> bool: ...
    ...
    def setDestinationCrs(self, crsWkt: str|None) -> None: ...
    def cellSize(self) -> QtCore.QSizeF: ...
    @typing.overload
    ...
    def gridOffset(self) -> QtCore.QPointF: ...
    def setGridOffset(self, offset: QtCore.QPointF|QtCore.QPoint) -> None: ...
    ...
    def progressHandler(self) -> 'QgsAlignRaster.ProgressHandler|None': ...
    def setProgressHandler(self, progressHandler: 'QgsAlignRaster.ProgressHandler|None') -> None: ...
...
class QgsNineCellFilter(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, inputFile: str|None, outputFile: str|None, outputFormat: str|None) -> None: ...
    @typing.overload
    ...
    def processRaster(self, feedback: _core.QgsFeedback|None = ...) -> 'QgsNineCellFilter.Result': ...
...
class QgsHillshadeFilter(QgsDerivativeFilter):
    ...
    @typing.overload
    def __init__(self, inputFile: str|None, outputFile: str|None, outputFormat: str|None, lightAzimuth: float = ..., lightAngle: float = ...) -> None: ...
    @typing.overload
...
class QgsKernelDensityEstimation(PyQt5.sip.wrapper):
    ...
    class Parameters(PyQt5.sip.wrapper):
        ...
        radius = ... # type: float
        radiusField = ... # type: str|None
        shape = ... # type: 'QgsKernelDensityEstimation.KernelShape'
        source = ... # type: _core.QgsFeatureSource
        weightField = ... # type: str|None
    ...
    def __init__(self, parameters: 'QgsKernelDensityEstimation.Parameters', outputFile: str|None, outputFormat: str|None) -> None: ...
...
class QgsRasterCalcNode(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, matrix: 'QgsRasterMatrix|None') -> None: ...
    @typing.overload
    def __init__(self, op: 'QgsRasterCalcNode.Operator', left: 'QgsRasterCalcNode|None', right: 'QgsRasterCalcNode|None') -> None: ...
    @typing.overload
    def __init__(self, functionName: str|None, functionArgs: collections.abc.Iterable['QgsRasterCalcNode']) -> None: ...
    @typing.overload
    def __init__(self, rasterName: str|None) -> None: ...

    def cleanRasterReferences(self) -> list[str]: ...
    def referencedLayerNames(self) -> list[str]: ...
    @staticmethod
    def parseRasterCalcString(str: str|None, parserErrorMsg: str|None) -> 'QgsRasterCalcNode|None': ...
    def findNodes(self, type: 'QgsRasterCalcNode.Type') -> list['QgsRasterCalcNode']: ...
    def toString(self, cStyle: bool = ...) -> str: ...
    def setRight(self, right: 'QgsRasterCalcNode|None') -> None: ...
    def setLeft(self, left: 'QgsRasterCalcNode|None') -> None: ...
...
class QgsRasterCalculator(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, formulaString: str|None, outputFile: str|None, outputFormat: str|None, outputExtent: _core.QgsRectangle, outputCrs: _core.QgsCoordinateReferenceSystem, nOutputColumns: int, nOutputRows: int, rasterEntries: collections.abc.Iterable[QgsRasterCalculatorEntry], transformContext: _core.QgsCoordinateTransformContext) -> None: ...
    @typing.overload
    def __init__(self, formulaString: str|None, outputFile: str|None, outputFormat: str|None, outputExtent: _core.QgsRectangle, nOutputColumns: int, nOutputRows: int, rasterEntries: collections.abc.Iterable[QgsRasterCalculatorEntry], transformContext: _core.QgsCoordinateTransformContext) -> None: ...
    @typing.overload
    @deprecated("""""")
    def __init__(self, formulaString: str|None, outputFile: str|None, outputFormat: str|None, outputExtent: _core.QgsRectangle, outputCrs: _core.QgsCoordinateReferenceSystem, nOutputColumns: int, nOutputRows: int, rasterEntries: collections.abc.Iterable[QgsRasterCalculatorEntry]) -> None: ...
    @typing.overload
    @deprecated("""""")
    def __init__(self, formulaString: str|None, outputFile: str|None, outputFormat: str|None, outputExtent: _core.QgsRectangle, nOutputColumns: int, nOutputRows: int, rasterEntries: collections.abc.Iterable[QgsRasterCalculatorEntry]) -> None: ...
    @typing.overload
    ...
    def processCalculation(self, feedback: _core.QgsFeedback|None = ...) -> 'QgsRasterCalculator.Result': ...
...
class QgsRelief(PyQt5.sip.wrapper):
    ...
    class ReliefColor(PyQt5.sip.wrapper):
        ...
        @typing.overload
        def __init__(self, c: QtGui.QColor|QtCore.Qt.GlobalColor, min: float, max: float) -> None: ...
        @typing.overload
        def __init__(self, a0: 'QgsRelief.ReliefColor') -> None: ...

    def __init__(self, inputFile: str|None, outputFile: str|None, outputFormat: str|None) -> None: ...

    def exportFrequencyDistributionToCsv(self, file: str|None) -> bool: ...
    ...
    def setZFactor(self, factor: float) -> None: ...
    def zFactor(self) -> float: ...
    def processRaster(self, feedback: _core.QgsFeedback|None = ...) -> int: ...
...
class QgsFeaturePool(_core.QgsFeatureSink):
    ...
    def __init__(self, layer: _core.QgsVectorLayer|None) -> None: ...
...
class QgsGeometryCheck(PyQt5.sip.wrapper):
    ...
    class Flags(PyQt5.sip.wrapper):
        ...
        def __init__(self) -> None: ...
        @typing.overload
        def __init__(self, f: 'QgsGeometryCheck.Flags'|'QgsGeometryCheck.Flag') -> None: ...

        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
        def __eq__(self, other: object): ...
        def __ixor__(self, f: 'QgsGeometryCheck.Flags'|'QgsGeometryCheck.Flag') -> 'QgsGeometryCheck.Flags': ...
        def __xor__(self, f: 'QgsGeometryCheck.Flags'|'QgsGeometryCheck.Flag') -> 'QgsGeometryCheck.Flags': ...
        def __ior__(self, f: 'QgsGeometryCheck.Flags'|'QgsGeometryCheck.Flag') -> 'QgsGeometryCheck.Flags': ...
        def __or__(self, f: 'QgsGeometryCheck.Flags'|'QgsGeometryCheck.Flag') -> 'QgsGeometryCheck.Flags': ...
        def __iand__(self, f: 'QgsGeometryCheck.Flags'|'QgsGeometryCheck.Flag') -> 'QgsGeometryCheck.Flags': ...
        def __and__(self, f: 'QgsGeometryCheck.Flags'|'QgsGeometryCheck.Flag') -> 'QgsGeometryCheck.Flags': ...
    ...
    @typing.overload
    def __init__(self, context: 'QgsGeometryCheckContext|None', configuration: dict[str, typing.Any]) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QgsGeometryCheck') -> None: ...

    def context(self) -> 'QgsGeometryCheckContext|None': ...
    ...
    def collectErrors(self, featurePools: typing.Any, errors: collections.abc.Iterable['QgsGeometryCheckError'], messages: collections.abc.Iterable[str|None], feedback: _core.QgsFeedback|None, ids: 'QgsGeometryCheck.LayerFeatureIds' = ...) -> typing.Tuple['QgsGeometryCheck.Result', list['QgsGeometryCheckError'], list[str]]: ...
    def flags(self) -> 'QgsGeometryCheck.Flags': ...
    def compatibleGeometryTypes(self) -> list[_core.Qgis.GeometryType]: ...
    def isCompatible(self, layer: _core.QgsVectorLayer|None) -> bool: ...
    def prepare(self, context: 'QgsGeometryCheckContext|None', configuration: dict[str, typing.Any]) -> None: ...


class QgsGeometryCheckResolutionMethod(PyQt5.sip.wrapper):

    @typing.overload
    def __init__(self, id: int, name: str|None, description: str|None, isStable: bool = ...) -> None: ...
    @typing.overload
...
class QgsGeometryCheckContext(PyQt5.sip.wrapper):
    ...
    def __init__(self, precision: int, mapCrs: _core.QgsCoordinateReferenceSystem, transformContext: _core.QgsCoordinateTransformContext, mProject: _core.QgsProject|None = ..., uniqueIdFieldIndex: int = ...) -> None: ...
...
class QgsGeometryCheckError(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, check: QgsGeometryCheck|None, layerFeature: 'QgsGeometryCheckerUtils.LayerFeature', errorLocation: _core.QgsPointXY, vidx: _core.QgsVertexId = ..., value: typing.Any = ..., valueType: 'QgsGeometryCheckError.ValueType' = ...) -> None: ...
    @typing.overload
    def __init__(self, check: QgsGeometryCheck|None, layerId: str|None, featureId: int, geometry: _core.QgsGeometry, errorLocation: _core.QgsPointXY, vidx: _core.QgsVertexId = ..., value: typing.Any = ..., valueType: 'QgsGeometryCheckError.ValueType' = ...) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QgsGeometryCheckError') -> None: ...

    def icon(self) -> QtGui.QIcon: ...
    def update(self, other: 'QgsGeometryCheckError|None') -> None: ...
    def closeMatch(self, a0: 'QgsGeometryCheckError|None') -> bool: ...
    def isEqual(self, other: 'QgsGeometryCheckError|None') -> bool: ...
    def setObsolete(self) -> None: ...
    def setFixFailed(self, reason: str|None) -> None: ...
    ...
    def layerId(self) -> str: ...
    def check(self) -> QgsGeometryCheck|None: ...
...
class QgsGeometryCheckerUtils(PyQt5.sip.wrapper):
    ...
    class LayerFeature(PyQt5.sip.wrapper):
        ...
        @typing.overload
        def __init__(self, pool: QgsFeaturePool|None, feature: _core.QgsFeature, context: QgsGeometryCheckContext|None, useMapCrs: bool) -> None: ...
        @typing.overload
...
class QgsGeometryCheckFactory(PyQt5.sip.wrapper):
    ...
    def description(self) -> str: ...
    def id(self) -> str: ...
    def createGeometryCheck(self, context: QgsGeometryCheckContext|None, configuration: dict[str, typing.Any]) -> QgsGeometryCheck|None: ...
...
class QgsGeometryCheckRegistry(PyQt5.sip.wrapper):
    ...
    def registerGeometryCheck(self, checkFactory: QgsGeometryCheckFactory|None) -> None: ...
    def geometryCheckFactories(self, layer: _core.QgsVectorLayer|None, type: QgsGeometryCheck.CheckType, flags: QgsGeometryCheck.Flags|QgsGeometryCheck.Flag = ...) -> list[QgsGeometryCheckFactory]: ...
    def geometryCheck(self, checkId: str|None, context: QgsGeometryCheckContext|None, geometryCheckConfig: dict[str, typing.Any]) -> QgsGeometryCheck|None: ...


class QgsSingleGeometryCheckError(PyQt5.sip.wrapper):

    @typing.overload
    def __init__(self, check: 'QgsSingleGeometryCheck|None', geometry: _core.QgsGeometry, errorLocation: _core.QgsGeometry, vertexId: _core.QgsVertexId = ...) -> None: ...
    @typing.overload
    ...
    def check(self) -> 'QgsSingleGeometryCheck|None': ...
    def description(self) -> str: ...
    def isEqual(self, other: 'QgsSingleGeometryCheckError|None') -> bool: ...
    def update(self, other: 'QgsSingleGeometryCheckError|None') -> None: ...


class QgsGeometryCheckErrorSingle(QgsGeometryCheckError):

    @typing.overload
    def __init__(self, singleError: QgsSingleGeometryCheckError|None, layerFeature: QgsGeometryCheckerUtils.LayerFeature) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QgsGeometryCheckErrorSingle') -> None: ...

    def singleError(self) -> QgsSingleGeometryCheckError|None: ...
...
class QgsSingleGeometryCheck(QgsGeometryCheck):
    ...
    def collectErrors(self, featurePools: typing.Any, errors: collections.abc.Iterable[QgsGeometryCheckError], messages: collections.abc.Iterable[str|None], feedback: _core.QgsFeedback|None = ..., ids: QgsGeometryCheck.LayerFeatureIds = ...) -> QgsGeometryCheck.Result: ...
...
class QgsGeometrySnapper(QtCore.QObject):
    ...
    def __init__(self, referenceSource: _core.QgsFeatureSource|None) -> None: ...
...
class QgsGeometrySnapperSingleSource(PyQt5.sip.wrapper):
    ...
    @staticmethod
    def run(source: _core.QgsFeatureSource, sink: _core.QgsFeatureSink, thresh: float, feedback: _core.QgsFeedback|None) -> int: ...


class QgsZonalStatistics(PyQt5.sip.wrapper):

    @typing.overload
    def __init__(self, polygonLayer: _core.QgsVectorLayer|None, rasterLayer: _core.QgsRasterLayer|None, attributePrefix: str|None = ..., rasterBand: int = ..., stats: _core.Qgis.ZonalStatistics|_core.Qgis.ZonalStatistic = ...) -> None: ...
    @typing.overload
    def __init__(self, polygonLayer: _core.QgsVectorLayer|None, rasterInterface: _core.QgsRasterInterface|None, rasterCrs: _core.QgsCoordinateReferenceSystem, rasterUnitsPerPixelX: float, rasterUnitsPerPixelY: float, attributePrefix: str|None = ..., rasterBand: int = ..., stats: _core.Qgis.ZonalStatistics|_core.Qgis.ZonalStatistic = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def calculateStatistics(self, feedback: _core.QgsFeedback|None) -> _core.Qgis.ZonalStatisticResult: ...
    @typing.overload
    @staticmethod
    def calculateStatistics(rasterInterface: _core.QgsRasterInterface|None, geometry: _core.QgsGeometry, cellSizeX: float, cellSizeY: float, rasterBand: int, statistics: _core.Qgis.ZonalStatistics|_core.Qgis.ZonalStatistic) -> dict[int, typing.Any]: ...
